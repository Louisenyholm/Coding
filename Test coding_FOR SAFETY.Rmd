...
Comparing models for hypothesis 1
```{r}
# Adding criterion
...
m0_ <- add_criterion(m0_, criterion = c("bayes_R2", "loo"))
m1_ <- add_criterion(m1_, criterion = c("bayes_R2", "loo"))
m2_ <- add_criterion(m2_, criterion = c("bayes_R2", "loo"))
